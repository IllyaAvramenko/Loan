...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "showModuleSlides",
    value: function showModuleSlides(btnSelector, turn) {
      var _this2 = this;

      document.querySelectorAll(btnSelector).forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();

          _this2.plusSlides(turn);
        });
      });
    }
  }, {
    ...
    value: function render() {
      if (this.container) {
        ...
        this.bindTriggers();
        this.showModuleSlides('.prevmodule', -1);
        this.showModuleSlides('.nextmodule', 1);
      }
    }
  }]);
      ...
      try {
        ...
        if (this.autoplay) {
          this.container.addEventListener('mouseenter', function () {
            return clearInterval(_this4.paused);
          });
